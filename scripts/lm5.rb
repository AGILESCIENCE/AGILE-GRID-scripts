...
#10) t2b
#11) t2bshift
#12) fovradmax: fov rad max, to be used also with fovbinnumber, default 60
#13) albedorad: default 80
#14) radius: of search, default 10
#15) timelist: a file with a list of tstart/stop
#16) timetype: CONTACT, MJD, UTC, TT, default TT
...
edpmatrix = datautils.edpmatrix;
	...
	cmd = "export PFILES=.:$PFILES; "+PATH+"bin/AG_lm5 "+listfile+" "+indexlog.to_s+" "+indexfilter.to_s+" "+sarmatrixfull.to_s+" "+edpmatrixfull.to_s+" "+
		  parameters.timelist.to_s+" "+mres+" "+lonpole.to_s+" "+" "+parameters.albedorad.to_s+" 0.5 360.0 5.0 "+
