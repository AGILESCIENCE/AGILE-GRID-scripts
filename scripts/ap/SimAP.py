...
class SimAP:
	...
	def calculateAPLC(self, help=1, mode='0', windowfile='', apfile='', ranal= 1, gasvalue=0.0006, gal = 0.7, iso = 10., emin = 100., emax = 10000., period = 729855.36, expdatafixed=0, peak_size = 50e-08, gindex=2.1, instrumentID=0):
		if (help == "1"):
			...
			erate.calculateRateAndSNR(verbose=1, ranal=ranal, exposure=expsum / len(expdataA), fluxsource=peak_size,  gasvalue=gasvalue, gal=gal, iso=iso, emin=emin, emax=emax, gindex=gindex, instrumentID=0)
