...
class DisplayLC:
    ...
    def get_value_from_array(self, data_array):
    ...
    # add filters in this funcion
    def display(self, mode, scatter, fixed_flux, tstart_window_mjd, tstop_window_mjd, file_one, file_two=""):
        ###### MAIN #########




        dict_one = self.extract_data(file_one,tstart_window_mjd,tstop_window_mjd)
        ...
        if(mode=="1"):
            ...
            data_array_one = self.get_value_from_array(dict_one)
        ...
        if(mode=="2"):
            ...
            dict_two = self.extract_data(file_two,tstart_window_mjd,tstop_window_mjd)
            ...
            if(plot_scatter is True):
                ...
                data_array_one = self.get_value_from_array(dict_one_clean)
                data_array_two = self.get_value_from_array(dict_two_clean)
            else:
                data_array_one = self.get_value_from_array(dict_one)
                data_array_two = self.get_value_from_array(dict_two)
