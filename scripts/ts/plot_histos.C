...
//type = 0, PDF
//type = 1, CDF
void plot_histos(int filetype = 0, TString type = "PDF", TString filenameinput1 = "", int style1 = 1, int color1 = kBlack, int width1 = 1, TString filenameinput2 = "", int style2 = 1, int color2 = kBlack, int width2 = 1, TString filenameinput3 = "", int style3 = 1, int color3 = kBlack, int width3 = 1, TString filenameinput4 = "", int style4 = 1, int color4 = kBlack, int width4 = 1) {
	...
	*/
	...
	Float_t BIN, BINCENTER, DPDF, EPDF, DCDF, ECDF, D, E, FPDF, FCDF, F;
	for (int i=0; i<4; i++) {
		if (filenameinput[i] == "") 
			continue;
		...
		if(filetype == 0) {
			nlines = T->ReadFile(filenameinput[i], "BIN:DPDF:EPDF:DCDF:ECDF");
			...
			nlines = T->ReadFile(filenameinput[i], "BIN:DPDF:EPDF:DCDF:ECDF:FPDF:FCDF");
